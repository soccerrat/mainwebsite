...
function ContactPage({ navigate }) {
  ...
  async function handleSubmit(event) {
    ...
    try {
      ...
      if (result.success) { trackEvent('contact_form_submitted'); form.reset(); setFormStatus({ type: 'success', message: 'Your request was sent. VeritaGrid will follow up soon.' }) }
...
function LegalPage({ kind, navigate }) {
  ...
  const sections = isPrivacy ? [
    ...
    { id: 'information', title: 'Information collected', paragraphs: ['Information is collected when it is provided directly, generated through use of the website, or needed to deliver requested services.'], bullets: ['Contact details such as name, email address, and phone number.', 'Details included in a support request, including the selected service and message.', 'Communications, estimates, project notes, and records related to requested or completed services.', 'Website usage information described in the Analytics section below.', 'Technical and security information generated by hosting providers to operate and protect the website.'] },
